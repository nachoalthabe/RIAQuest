...
var Application = new Class(
    {
      ...
      Binds: [
          '_getName','_getFolderPath'
      ],
      classQueue: [
          'Component','CatBag','SingletonCatBag','CatBags/ControllersCatBag',
          'CatBags/ModelsCatBag','CatBags/OperationsCatBag',
          'CatBags/ServicesCatBag','CatBags/ViewsCatBag',
          'Components/Controller','Components/Model','Components/Operation',
      ...
      includeScript: function(){
        ...
        script.src = this.options.folders.core+toLoad+'.class.js';
        script.async = false;
      ...
      loadResource: function(){
        ...
        resource.path = resource.catBag.getResourcePath(resource.resourceName,
            true);
        resource.classID = resource.catBag
            .getClassID(resource.resourceName,'_')
        var req = new Request({
          url: resource.path,
          async: false,
          evalResponse: false,
